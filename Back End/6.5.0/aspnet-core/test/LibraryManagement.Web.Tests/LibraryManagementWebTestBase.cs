...
{
    public abstract class LibraryManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LibraryManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LibraryManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LibraryManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LibraryManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LibraryManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LibraryManagementDbContext, Task<T>> func)
        {
            T result;
